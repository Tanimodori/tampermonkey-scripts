...
import { unpaced } from '../src/dispatch.js';
import type { TencentDocsError } from '../src/errors.js';
import type { CallDescriptor, CallOutcome } from '../src/hooks.js';
import { sendBare, sendEnvelope } from '../src/internal/request.js';
import type { CallContext, CallRequest } from '../src/internal/request.js';
import { newDispatcher } from '../src/internal/transport.js';
import { GetRecordsResponseSchema, RefreshTokenResponseSchema, UserInfoResponseSchema } from '../src/schemas.js';
 ...
 *
 * The verdicts themselves are `internal/classify.spec.ts`'s; what is pinned here is that a call makes
