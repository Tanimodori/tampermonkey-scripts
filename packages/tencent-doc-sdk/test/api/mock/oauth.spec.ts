import { apiOrigin, refreshTokenRefused, setupTencentDocsMock } from '@test/testUtils/document.js';
 ...
 * (`../live/oauth.spec.ts`); the refresh does not, because a test document's environment carries no
