...
| [@logtape/logtape](https://logtape.org) | 日志（[配置](https://logtape.org/manual/config)、[格式化](https://logtape.org/manual/formatters)） |
...
| [vitest](https://vitest.dev) | 测试（[test tags](https://vitest.dev/guide/test-tags)、[命令行](https://vitest.dev/guide/cli)） |
